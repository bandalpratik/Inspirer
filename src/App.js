    ...
    <div className="app">
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <div style={modalStyle} className={classes.paper}>
          <form className="app__signup">
            <center>
              <img className="app__headerImageSignUp" src={Inspirer} alt="" />
      ...
      <Modal open={openSignIn} onClose={() => setOpenSignIn(false)}>
        <div style={modalStyle} className={classes.paper}>
          <form className="app__signup">
            <center>
              <img className="app__headerImageSignIn" src={Inspirer} alt="" />
            </center>
            ...
            <Button id="app_signInButton" onClick={signIn}>
              Sign In
            </Button>

            <div className="imageupload__videolink">
              <span className="imageupload__videolink_">OR</span>
            </div>
      ...
      {/*Avatar Upload Modal */}
      <Modal open={openAvatarUpload} onClose={() => setOpenAvatarUpload(false)}>
        {/*Upload Content */}
        <div style={modalStyle} className={classes.paper}>
          <center>
            <img className="app__headerImageSignIn" src={Inspirer} alt="" />
      ...
      <Modal open={openResetP} onClose={() => setOpenResetP(false)}>
        {/*Upload Reset Content */}
        <div style={modalStyle} className={classes_reset.paper}>
          <button
            onClick={(e) => setOpenResetP(false)}
            className="reset_cancel_icon"
          >
            <CloseIcon />
          </button>
          <div className="reset_header">
            <div className="reset_header_span">Reset password</div>
          </div>
          ...
          <div className="reset_footer">
            <button
              onClick={(e) => setOpenResetP(false)}
              className="reset_footer_cancel md-button"
            >
              Cancel
            </button>
            <button
              onClick={handleReset}
              className="reset_footer_send md-button"
            >
              Send
            </button>
          </div>
      ...
      <div className="app_posts">
        {posts.map((post) => (
          <Post
            key={post.id}
            videoLink={post.post.videoLink}
            date={post.post.timestamp}
            avatarImage={post.post.avatarImage}
            user={user}
            postId={post.id}
